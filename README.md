An R package to calculate stock measures from the most recent V-Dem (Varieties of Democracy) dataset. 

Calculate stock measures from V-Dem data

Load V-Dem data and calculate stock measures for various depreciation rates

This package allows you to generate a cumulative weighted sum of past values for any V-Dem variable with user-defined weights. The resulting measure is re-scaled to represent the share of the total possible stock the country could have accumulated up until that year. 
